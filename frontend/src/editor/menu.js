...
export function buildMenuItems(schema) {
  ...
  if (type = schema.nodes.file_embed)
    r.insertFile = insertFile(type);
  ...
  r.insertMenu = new Dropdown(cut([r.insertImage, r.insertHorizontalRule, r.insertFile]), { label: "Insert" });
